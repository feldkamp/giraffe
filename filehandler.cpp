...
int main (int argc, char * const argv[]) {
	...
	array2D<double> *first = 0;
	array2D<double> *second = 0;
	...
	if (mode == "thresholding" || mode == "mask_invert"){ 
		...
		if (mode == "thresholding"){
			...
			array2D<double> *rejected = new array2D<double>( first->dim1(), first->dim2() );
